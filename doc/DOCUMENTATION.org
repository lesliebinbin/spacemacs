...
When the Spacemacs checkout contains a =.spacemacs.d/= directory, its =init.el=
is used automatically. This supports keeping the configuration as a submodule
of the Spacemacs repository.
